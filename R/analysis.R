...
runDataProcessing <- function(aso) {
  ...
  aso:::runQcForReferencePlate(aso)
...
runQcForReferencePlate <- function(aso) {
  reportPath = runReferenceQC(aso@plateSet, aso@methodParameters$root_dir, aso@methodParameters$plate_file_list[[1]])
  return(reportPath)
}
